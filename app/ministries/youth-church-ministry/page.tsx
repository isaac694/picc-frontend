              ...
              <div className="overflow-hidden rounded-2xl border border-white/15 bg-black/50 shadow-2xl">
                ...
                {activeTool && (
                  <div className="border-t border-black/10 bg-gray-50 text-black">
                    ...
                    {activeTool === "chat" && <div className="h-[400px] w-full bg-white"><LiveChat videoId={featuredVideo?.videoId || FALLBACK_HERO_ID} videoTitle={featuredVideo?.title || 'Youth Church Live'} /></div>}
