...
export const metadata = {
  title: 'School of Discipleship Events',
  description: 'Upcoming events for the School of Discipleship',
};

export default function DiscipleshipEventsPage() {
  return (
    <>
      <Navigation />
        ...
        <section className="py-16 md:py-20 bg-[#0d1f3c] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-white/80 max-w-2xl mx-auto">
              Browse upcoming discipleship events and register to attend.
            </p>
          </div>
        </section>
