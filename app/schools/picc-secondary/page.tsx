...
import { GraduationCap, Users, BookOpen, Award, Globe, Heart } from 'lucide-react';
...
export default function PICCSecondaryPage() {
  const features = [
    {
      ...
      description: 'Rigorous curriculum combining faith-based education with modern pedagogy',
      num: '01',
    },
    {
      icon: Heart,
      title: 'Character Development',
      description: 'Holistic education focused on building Christ-centered leaders',
      num: '02',
    },
    {
      icon: Users,
      title: 'Community Focus',
      description: 'Strong emphasis on teamwork, service, and community involvement',
      num: '03',
    },
    {
      icon: Globe,
      title: 'Global Perspective',
      description: 'Preparing students for excellence in a diverse world',
      num: '04',
    },
    {
      icon: Award,
      title: 'Student Achievement',
      description: 'Consistent academic and sporting excellence recognition',
      num: '05',
    },
    {
      icon: GraduationCap,
      title: 'University Preparation',
      description: 'Comprehensive guidance for tertiary education advancement',
      num: '06',
    },
  ];
  ...
  const programs = [
    {
      name: 'Science Track',
      description: 'Physics, Chemistry, Biology, Mathematics — STEM-focused pathway',
      level: 'Form 3–6',
    },
    {
      name: 'Humanities Track',
      description: 'Literature, History, Geography, Economics — Arts pathway',
      level: 'Form 3–6',
    },
    {
      name: 'Business Studies',
      description: 'Accounting, Business Management, Economics — Commerce pathway',
      level: 'Form 3–6',
    },
    {
      name: 'Christian Living',
      description: 'Integral spiritual formation woven throughout the curriculum',
      level: 'All Forms',
    },
  ];
    ...
    <div className="flex flex-col min-h-screen bg-stone-50">
      ...
      <section className="relative bg-[#0d1f3c] overflow-hidden py-28 px-4 text-center">
        ...
        <p className="relative text-white/70 text-lg sm:text-xl italic font-serif max-w-lg mx-auto leading-relaxed mb-10">
          Equipping young minds and hearts for academic excellence and spiritual growth
        </p>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-[1fr_1px_1fr]">
          <div className="text-center px-8 py-6">
            ...
            <p className="text-white/65 text-base leading-relaxed font-serif italic">
              To provide quality Christian education that develops intellectually capable, spiritually
              grounded, and socially responsible young people — effective agents of positive change.
            </p>
          </div>
          ...
          <div className="text-center px-8 py-6 border-t border-[#c9a84c]/20 md:border-t-0">
            ...
            <p className="text-white/65 text-base leading-relaxed font-serif italic">
              A community of excellence where every student discovers their God-given potential and
              is equipped with knowledge, skills, and Christian values to lead transformational lives.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-stone-50 py-20 px-4">
        <div className="text-center mb-14">
          ...
          <h2 className={`${sectionTitleClass} text-[#0d1f3c] font-serif`}>The PICC Difference</h2>
          {dividerEl}
        </div>

        <div className="max-w-5xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200">
          {features.map(({ icon: Icon, title, description, num }, index) => (
      ...
      <section className="bg-[#0d1f3c] py-20 px-4">
        <div className="text-center mb-14">
          ...
          <h2 className={`${sectionTitleClass} text-white font-serif`}>Academic Programs</h2>
          {dividerEl}
        </div>

        <div className="max-w-4xl mx-auto grid sm:grid-cols-2 gap-px bg-[#c9a84c]/20">
          {programs.map(({ name, description, level }, index) => (
      ...
      <section className="bg-stone-50 py-20 px-4">
        ...
        <div className="max-w-3xl mx-auto grid sm:grid-cols-3 gap-px bg-slate-200">
          {[
            ...
            { icon: '⊕', label: 'Location', lines: ['Area 49, Lilongwe'] },
